<?php
		...
		if(!is_array($rateData)){
			$insertClause = array('user_id' =>$userObj->id,'api_name' => 'Purolator','response_short' => 'Fail','response' => json_encode(array("No Response Return")));
		}else{
			$insertClause = array('user_id' =>$userObj->id,'api_name' => 'Purolator','response_short' => 'Success','response' => json_encode($rateData));
		}
