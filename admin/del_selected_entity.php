...
if($p_User_Id)
{
	$query = "delete from users where User_Id = '$p_User_Id'" or die(mysql_error());
...
if($p_Star_User_Id)
{
	$query = "delete from admin_users where User_Id = '$p_Star_User_Id' and Owner!='self'" or die(mysql_error());
	mysql_query($query,$cn) or die(mysql_error());
